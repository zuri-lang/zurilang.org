...
: class Token
  ...
  **.type** &#x279D; _string_ {#markdown.Token.type}
  : Type of the token (string, e.g. "paragraph_open")

  **.tag** &#x279D; _string_ {#markdown.Token.tag}
  : html tag name, e.g. "p"

  **.attrs** &#x279D; _list_ {#markdown.Token.attrs}
  : Html attributes. Format: `[ [ name1, value1 ], [ name2, value2 ] ]`.

  **.map** &#x279D; _list_ {#markdown.Token.map}
  : Source map info. Format: `[ line_begin, line_end ]`.

  **.nesting** &#x279D; _number_ {#markdown.Token.nesting}
  : Level change (number in {-1, 0, 1} set), where:
    -  `1` means the tag is opening
    -  `0` means the tag is self-closing
    - `-1` means the tag is closing

  **.level** &#x279D; _number_ {#markdown.Token.level}
  : nesting level, the same as `state.level`.

  **.children** &#x279D; _list_ {#markdown.Token.children}
  : A list of child nodes (inline and img tokens).

  **.content** &#x279D; _string_ {#markdown.Token.content}
  : In a case of self-closing tag (code, html, fence, etc.),
    it has contents of this tag.

  **.markup** &#x279D; _string_ {#markdown.Token.markup}
  : '' or '_' for emphasis, fence string for fence, etc.

  **.info** &#x279D; _string_ {#markdown.Token.info}
  : Additional information:
    - Info string for "fence" tokens
    - The value "auto" for autolink "link_open" and "link_close" tokens
    - The string value of the item marker for ordered-list "list_item_open" tokens

  **.meta** &#x279D; _dict_ {#markdown.Token.meta}
  : A place for plugins to store an arbitrary data.

  **.block** &#x279D; _bool_ {#markdown.Token.block}
  : True for block-level tokens, false for inline tokens.
    Used in renderer to calculate line breaks.

  **.hidden** &#x279D; _bool_ {#markdown.Token.hidden}
...
: Markdown parsing and rendering class.
  ...
  **.renderer** &#x279D; _Renderer_ {#markdown.Markdown.renderer}
  ...
  **.validate\_link** {#markdown.Markdown.validate_link}
  ...
  **.normalize\_link** {#markdown.Markdown.normalize_link}
  ...
  **.normalize\_link\_text** {#markdown.Markdown.normalize_link_text}
  : Function used to decode link url to a human-readable format`
    
    @param string url
    @returns string

  **.utils** &#x279D; _module_ {#markdown.Markdown.utils}
  : Assorted utility functions, useful to write plugins. See details
    [here](https://github.com/blade-lang/blade/blob/master/libs/markdown/common/utils.b).

  **.helpers** &#x279D; _dict_ {#markdown.Markdown.helpers}
...
: Helper class, used by `markdown#core`, `markdown#block` and
  ...
  rules control use [markdown.disable](#markdown.markdown.disable), [Markdown.enable](#markdown.Markdown.enable) and
  ...
  : Add new rule to chain before one with given name. See also
    [Ruler.after](#markdown.Ruler.after), [Ruler.push](#markdown.Ruler.push).
    ##### Options:
    - __alt__ - list with names of "alternate" chains.
    ##### Example
    ```blade
  ...
  : Add new rule to chain after one with given name. See also
    [Ruler.before](#markdown.Ruler.before), [Ruler.push](#markdown.Ruler.push).
    ##### Options:
    - __alt__ - list with names of "alternate" chains.
    ##### Example
    ```blade
  ...
  : Push new rule to the end of chain. See also
    [Ruler.before](#markdown.Ruler.before), [Ruler.after](#markdown.Ruler.after).
    ##### Options:
    - __alt__ - list with names of "alternate" chains.
    ##### Example
    ```blade
  ...
  : Enable rules with given names. If any rule name not found - dies Exception.
    ...
    See also [Ruler.disable](#markdown.Ruler.disable), [Ruler.enable_only](#markdown.Ruler.enable_only).
  ...
  : Enable rules with given names, and disable everything else. If any rule name
    ...
    See also [Ruler.disable](#markdown.Ruler.disable), [Ruler.enable](#markdown.Ruler.enable).
  ...
  : Disable rules with given names. If any rule name not found - throw Error.
    Errors can be disabled by second param.
    Returns list of found rule names (if no exception happened).
    See also [Ruler.enable](#markdown.Ruler.enable), [Ruler.enable_only](#markdown.Ruler.enable_only).
...
: Generates HTML from parsed token stream. Each instance has independent
  ...
  **.rules** &#x279D; _dict_ {#markdown.Renderer.rules}
